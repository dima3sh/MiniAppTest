...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: orvYAM0G-kSD/css
...
function PlasmicContactSection__RenderFunc(props) {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox__gICo)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__cnezH)}>
          <PlasmicLink__
